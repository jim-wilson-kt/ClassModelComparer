...
<xsl:stylesheet exclude-result-prefixes="xs" version="2.0"
									...
									<div class="container" style="margin-top:30px">
										<div class="row">
											<div class="col">
												...
												<ol>
												<xsl:apply-templates select="/ClassComparison/ClassComparison[Existence='ArgoOnly']" mode="namelist">
									...
									<div class="container" style="margin-top:30px">
										<div class="row">
											<div class="col">
												...
												<ol>
													<xsl:apply-templates select="/ClassComparison/ClassComparison[Existence='DotNetOnly']" mode="namelist">
														<xsl:sort select="ClassName"/>
													</xsl:apply-templates>
												</ol>
											</div>
									...
									<div class="container" style="margin-top:30px">
										...
										<div class="row">
											...
											<div class="col">
												<h4>Badges</h4>
												<ul>
													<li><span class="badge badge-warning">Argo</span>&#160;ArgoUML Property Missing</li>
													<li><span class="badge badge-warning">.NET</span>&#160;.NET Property Missing</li>
													<li><span class="badge badge-danger">T</span>&#160;Type incompatibility</li>
													<li><span class="badge badge-danger">M</span>&#160;Multiplicity (occurrence) mismatch</li>
												</ul>
											</div>
										</div>
										<div class="row">
											<div class="col">
												<div class="dropdown">
													...
													<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
														<xsl:apply-templates select="ClassComparison/ClassComparison[Existence='Both']/ClassName">
															<xsl:sort select="."/>
														</xsl:apply-templates>
													</div>
												</div>
												<table class="table table-sm table-hover table-bordered table-striped">
													<tbody>
												<xsl:apply-templates select="/ClassComparison/ClassComparison[Existence='Both']" mode="comparison">
													<xsl:sort select="ClassName"/>
												</xsl:apply-templates>
													</tbody>
												</table>
	...
	<xsl:template match="ClassComparison/Config">
		<h3>Source Files</h3>
		<ul>
			<li><xsl:value-of select="ArgoUmlFilepath"/></li>
			<li><xsl:value-of select="DotNetAssemblyFilepath"/></li>
		</ul>
		<h3>Configuration</h3>
	...
	<xsl:template match="TypeEquivalency">
		<tr>
			<td><xsl:value-of select="Argo"/></td>
			<td><xsl:value-of select="DotNet"/></td>
		</tr>
	</xsl:template>
	...
	<xsl:template match="ClassComparison" mode="comparison">
		<tr class="table-success"><td colspan="3"><a name="{ClassName}"></a><br /><h4><xsl:value-of select="ClassName"/>&#160;&#160;<a href="#top" class="btn btn-outline-primary btn-sm">Top</a></h4></td></tr>
		<xsl:apply-templates select="PropertyComparisonList/PropertyComparison" mode="#default"/>
	</xsl:template>
	<xsl:template match="PropertyComparison" mode="#default">
		<tr>
			<td>
				<xsl:apply-templates select=".[Existence='DotNetOnly']" mode="missing-argo-class"/>
				<xsl:value-of select="PropertyName"/>
				<xsl:apply-templates select=".[Existence='ArgoOnly']" mode="missing-dotnet-class"/>
			</td>
			<td>
				<xsl:apply-templates select=".[DataTypesAreCompatible='false']" mode="type"/>
				<xsl:value-of select="ArgoProperty/DataType"/>&#160;/&#160;
				<xsl:value-of select="DotNetProperty/DataType"/>
			</td>
			<td>
				<xsl:apply-templates select=".[MinOccursAreSame='false' or MaxOccursAreSame='false']" mode="multiplicity"/>
				<xsl:value-of select="ArgoProperty/MinOccurs"/>..<xsl:value-of select="ArgoProperty/MaxOccurs"/>&#160;/&#160;
				<xsl:value-of select="DotNetProperty/MinOccurs"/>..<xsl:value-of select="DotNetProperty/MaxOccurs"/>
			</td>
		</tr>
	</xsl:template>
	<xsl:template match="PropertyComparison" mode="type">
		<span class="badge badge-danger">T</span>&#160;
	</xsl:template>
	<xsl:template match="PropertyComparison" mode="multiplicity">
		<span class="badge badge-danger">M</span>&#160;
	</xsl:template>
	<xsl:template match="PropertyComparison" mode="missing-argo-class">
		<span class="badge badge-warning">Argo</span>&#160;/
	</xsl:template>
	<xsl:template match="PropertyComparison" mode="missing-dotnet-class">
		/&#160;<span class="badge badge-warning">.NET</span>
	</xsl:template>
</xsl:stylesheet>
